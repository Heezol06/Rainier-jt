...
const Sidebar = () => {
    return (
        <CDBSidebar textColor="#333" backgroundColor="#f0f0f0" height="100%">
            <CDBSidebarHeader className="flex justify-between" prefix={<i className="fa fa-bars" />}>
                ...
                Medi<span className='Hot-Pink'>Doc</span>
            </CDBSidebarHeader>
